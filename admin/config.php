<?php
// HTTP
define('HTTP_SERVER', 'http://klaasbakker.nl/slique/admin/');
define('HTTP_CATALOG', 'http://klaasbakker.nl/slique/');

// HTTPS
define('HTTPS_SERVER', 'http://klaasbakker.nl/slique/admin/');
define('HTTPS_CATALOG', 'http://klaasbakker.nl/slique/');

// DIR
define('DIR_APPLICATION', '/var/www/vhosts/klaasbakker.nl/www/html/slique/admin/');
...
define('DIR_CATALOG', '/var/www/vhosts/klaasbakker.nl/www/html/slique/catalog/');
